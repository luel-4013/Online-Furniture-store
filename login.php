...
<h1><a href="index.html"><span>DM Furniture</span> Store</a></h1>
			...
			<div class="n1s_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:Dmfurnituree@Gmail.com">Dmfurnituree@Gmail.com</a></li>			</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
      ...
      else if ($username!=null || $password!=null)
      {
       ...
       $sql=mysqli_query($conn,"select * from Verify where username='$username' and password='$password'") or die("failed to query database");
            ...
            { 
            		...
            		echo "<script> location.href='Dining.html';</script>";
            	}
              ...
              else 
            {
               ...
               echo"<font color=maroon><center><h4>INVALID USERNAME AND PASSWORD</center><h4></font>";
...
$sql=mysqli_query($conn,"insert into Verify values('$username','$password','$email','$phone')");
